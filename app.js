...
const mockDB = {
  ...
  courses: [
    { id: 1, title: "Introduction to Psychology", description: "Explore the foundational principles of human behavior, cognition, and emotions.", duration: "3 Months", fees: 499, faculty_id: "f1" },
    { id: 2, title: "Clinical Psychology & Counseling", description: "Advanced training in diagnostics, therapeutic methods, and counseling practices.", duration: "6 Months", fees: 899, faculty_id: "f1" },
    { id: 3, title: "Child & Adolescent Development", description: "Analyze behavioral psychology and neurological development from infancy to adolescence.", duration: "4 Months", fees: 599, faculty_id: "f1" }
  ],
  enrollments: [
    { id: 1, student_id: "s1", course_id: 1, status: "active", enrolled_at: "2026-06-01T10:00:00Z" }
  ],
  fees: [
    { id: 1, student_id: "s1", course_id: 1, amount: 499, status: "pending", due_date: "2026-07-15", paid_at: null, payment_method: null, receipt_no: null }
  ],
  attendance: [
